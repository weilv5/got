            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select id="albumSort" name="albumSort" class="form-select-button"></select>
                    </div>
                </div>
                <div class="layui-inline">
...
<script>
    ...
    layui.config({
        ...
        function add(data) {
            url = "${ctxPath}/photoManage/?method=edit";
            if (data) {
                url += "&id=" + data.id;
                openSubmitLayer(url, "编辑照片", '800px', '500px');
            }else {
                openSubmitLayer(url, "添加照片", '800px', '500px');
            }
        }
        ...
        function detail(data) {
            layer.open({
                ...
                maxmin: true,
                area: ["800px", "500px"],
                content: "${ctxPath}/photoManage/?method=view&id=" + data.id
            });
        }
...
<script type="text/html" id="photoTmp">
    <img style="height: 100%;" src="{{d.photo}}">
</script>
